...
// System.Diagnostics.CodeAnalysis.MaybeNullWhenAttribute and NotNullWhenAttribute are not available in the
// netstandard2.0 reference assemblies; they can be provided inline for the compiler to honor on public APIs.
...
internal sealed class NotNullWhenAttribute : Attribute
{
    /// <summary>Initializes the attribute with the specified return value condition.</summary>
    /// <param name="returnValue">
    /// The return value condition. When the method returns this value, the associated parameter is not <see langword="null"/>.
    /// </param>
