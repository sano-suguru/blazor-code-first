...
public class ScopedCssRewriterTests
{
    ...
    [InlineData("-o-")]
    [InlineData("-ms-")]
    public void AddsScopeToVendorPrefixedKeyframeNames(string prefix) =>
        AssertRewrite(
    ...
    public void RewritesAnimationNamesWhenMatchingVendorPrefixedKeyframes() =>
        AssertRewrite(
            "\n    .myclass { animation: fade 1s infinite; }\n    @-webkit-keyframes fade { from{opacity:0} to{opacity:1} }\n",
            "\n    .myclass[TestScope] { animation: fade-TestScope 1s infinite; }\n    @-webkit-keyframes fade-TestScope { from{opacity:0} to{opacity:1} }\n");

    [Fact]
    public void RewritesVendorPrefixedAnimationPropertyWhenMatchingVendorPrefixedKeyframes() =>
        AssertRewrite(
            "\n    .myclass { -webkit-animation: fade 1s infinite; -webkit-animation-name: fade; }\n    @-webkit-keyframes fade { from{opacity:0} to{opacity:1} }\n",
            "\n    .myclass[TestScope] { -webkit-animation: fade-TestScope 1s infinite; -webkit-animation-name: fade-TestScope; }\n    @-webkit-keyframes fade-TestScope { from{opacity:0} to{opacity:1} }\n");
}
