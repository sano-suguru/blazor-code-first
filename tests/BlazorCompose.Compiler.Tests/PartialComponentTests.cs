...
/// <summary>
/// BC1001 must be reported by the generator, not by an analyzer.  Its trigger condition — a class that
...
/// compilation that has one.  An analyzer-reported BC1001 is therefore unreachable in a real build: the
/// condition it diagnoses is the condition that suppresses it (issue #76).  The generator driver has no
/// such gate, which is why BC1003 and BC1005 survive the same CS0534.
/// </summary>
public sealed class PartialComponentTests
{
    ...
    [Fact]
    public void Generator_NonPartialComponent_ReportsBC1001AtClassIdentifier()
    {
        ...
        // BC1003 is about constructs inside the expression. The expression here is fine; the missing
    ...
    [Fact]
    public void Generator_IntermediateBaseWithoutDesignTimeExpression_ReportsNoBC1001()
    {
        ...
        Assert.DoesNotContain(result.Diagnostics, d => d.Id == "BC1001");
    }

    [Fact]
    public void Generator_LeafWhoseBaseAlreadyDeclaresTheExpression_ReportsNoBC1001()
    {
    ...
    [Fact]
    public void Generator_ReAbstractedExpression_ReportsNoBC1001()
    {
    ...
    [Fact]
    public void Generator_NonPartialDerivedReOverridingTheExpression_ReportsBC1001()
    {
    ...
    [Fact]
    public void Generator_NonPartialWithHandWrittenRenderView_ReportsNoBC1001()
    {
        ...
        // class that declares no design-time expression. The analyzer that used to own BC1001 could not
    ...
    [Fact]
    public void Generator_NestedNonPartialComponent_ReportsBC1005NotBC1001()
    {
        // Both modifiers are wrong here, but only one remedy exists: adding `partial` to a nested class
        // still generates nothing, so BC1001's "add the partial modifier" would be a false lead. BC1005
        ...
        Assert.Single(result.Diagnostics, d => d.Id == "BC1005");
        Assert.DoesNotContain(result.Diagnostics, d => d.Id == "BC1001");
    }
}
