...
public sealed class HtmlAttributeGeneratorTests
{
    ...
    {
        Assert.Contains(Diags("""Html.A.Id("a").Id("b")["L"]"""), d => d.Id == "BC3010");
        Assert.Contains(Diags("""Html.A.Href("x").Attr("href", "y")["L"]"""), d => d.Id == "BC3010");
    }

    [Fact]
    public void DuplicateEvent_ReportsBC3010()
    {
        Assert.Contains(Diags("""Html.Button.OnClick(() => { }).On("onclick", () => { })["x"]"""), d => d.Id == "BC3010");
    }

    [Fact]
    public void DistinctAttributesAndEvents_NoBC3010()
    {
        Assert.DoesNotContain(Diags("""Html.A.Href("x").Id("i").Title("t")["L"]"""), d => d.Id == "BC3010");
