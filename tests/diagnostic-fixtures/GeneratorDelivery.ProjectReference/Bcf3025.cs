...
/// </summary>
/// <remarks>
/// The arity half (a <c>SlotView</c> part naming its slot zero times or twice) is reported at the
/// declaration instead, and is covered in-process by <c>ViewPartContentDiagnosticTests</c>. A real build
