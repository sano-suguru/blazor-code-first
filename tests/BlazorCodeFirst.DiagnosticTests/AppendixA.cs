...
/// <summary>One row of the Appendix A table: the diagnostic it documents and the severity it claims.</summary>
/// <param name="Kind">
...
/// <summary>
/// What <c>ARCHITECTURE.md</c> Appendix A documents, read out of the canonical table itself.
/// </summary>
/// <remarks>
/// Deliberately tolerant about everything except what is being checked: it takes the section between
/// the Appendix A heading and the next top-level heading, then every row whose first cell is a BCF ID and
/// reads the second cell as the severity. The prose, the column count beyond the second, and the
/// sub-heading structure inside Appendix A can all change without touching this parser. Moving or renaming
...
{
    private const string SectionHeading = "## Appendix A";
