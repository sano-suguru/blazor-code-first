...
public sealed class PackageContentsTests
{
    ...
    public void RepeatedPack_WhenStagedCompilerOutputIsStale_RebuildsCompilerAnalyzer()
    {
        ...
        var compilerEntry = packageArchive.GetEntry("analyzers/dotnet/cs/BlazorCodeFirst.Compiler.dll");
    ...
    private static string FindRepositoryRoot()
    {
        ...
        {
            if (File.Exists(Path.Combine(current.FullName, "BlazorCodeFirst.slnx")))
            {
