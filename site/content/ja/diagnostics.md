...
明示的な `break` も添えられます。`foreach` はこの位置ではまだ受け付けません。今も
[BCF1004](#bcf1004)/[BCF3004](#bcf3004)/BCF1002 のままです。
