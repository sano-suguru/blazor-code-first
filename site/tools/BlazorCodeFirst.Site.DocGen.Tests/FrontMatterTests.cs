...
public class FrontMatterTests
{
    private const string Valid =
        "---\ntitle: Getting Started\ndescription: How to install the package and render a component.\n" +
        "order: 10\ngroup: start\n---\n\n## Installation\n";
    ...
    [Fact]
    public void Split_ValidFrontMatter_ReturnsDescription()
    {
        var (fields, _) = FrontMatter.Split(Valid, "getting-started.md");

        Assert.Equal("How to install the package and render a component.", fields.Description);
    }
    ...
    [InlineData("---\ntitle: T\ndescription: A\norder: 1\ngroup: write\ndescription: B\n---\n", "more than once")]  // duplicate description
